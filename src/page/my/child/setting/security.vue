...
<style>
	.header_portrait{width: 100%;height: 3.05rem;line-height: 3.05rem;margin-top: 0.5rem; padding-left: 0.5rem;padding-right: 0.5rem;border-bottom: 0.05rem solid #e9e9e9;  text-align: left; background-color: white;}
	.header_portrait img{width: 2.5rem;height: 2.5rem; display: inline-block;top: 0.3rem; right: 0.5rem;border-radius: 50%; position: absolute;}
	.user_name{width: 100%;height: 2.1rem;border-bottom: 0.05rem solid #e9e9e9;line-height: 2.1rem;padding-left: 0.5rem;padding-right:0.5rem; text-align: left; background-color: white;}
	.user_name span{float: right;color: #999999;}
	.bind,.security_setting{width: 100%;margin-top: 0.5rem;}
	.bind p,.security_setting p{width: 100%;height: 2.1rem;line-height: 2.1rem;text-align:left;padding-left: 0.5rem;padding-right: 0.5rem;border-bottom:0.05rem solid #e9e9e9;background-color: white;}
	.bind span,.security_setting span{float: right;color: #2898ff;}
	.bind img{width: 1.1rem;margin-right: 0.25rem; vertical-align: middle; display: inline-block;}
	.header_portrait_popup{width: 100%;height: 7rem;}
	.header_portrait_popup p{padding-left:1.0rem;padding-right: 1.0rem; text-align: left;}
	.file{width: 100%;height: 100%;top: 0.0rem;left: 0.0rem;opacity: 0; position: absolute; background-color: red;}
