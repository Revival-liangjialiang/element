...
<style>
	.modify_username p{margin-top: 0.5rem;margin-bottom: 0.5rem;font-size: 0.6rem;padding-left: 0.5rem; text-align: left; color: #999999;}
	.modify_username button{width: 15.35rem;height: 2.15rem;border-radius: 0.25rem; color: white;background-color: #cccccc;}
	.name .cell-left,.password .cell-left{width: 3.5rem;line-height: 2.25rem; padding-left:0.5rem; display: inline-block !important;}
	.name span{padding-top: 0.025rem;}
</style>
