...
<style scoped>
	.activity{width: 100%;height: 2.35rem;text-align: left; background-color: #0097ff;}
	.activity_nav{width:auto;height: 2.35rem;display:block;}
	.activity_nav li{height: 2.1rem;line-height: 2.1rem; padding-left: 0.5rem;padding-right: 0.5rem;margin-left: 1.0rem;color: white;}
	.activity_nav .active{border-bottom: 0.1rem solid white;}
	.popup_box{width: 100%;height: 8.0rem; padding-left: 0.5rem;padding-right: 0.5rem;left: 0.0rem;bottom: 0.5rem;position: absolute; }
	.popup_box img{width: 1.3rem;height: 1.3rem;margin-right: 0.5rem; vertical-align: middle; display: inline-block;}
	.popup_box p{width: 100%;height: 2.15rem; line-height: 2.15rem;}
	.popup_box span{vertical-align: middle;}
	.popup_box em{margin-bottom: 0.5rem;display: inline-block;}
	.join_box{width: 13.75rem;height: 9.0rem;}
	.join_box .one{font-size: 0.7rem;margin-top:0.6rem;color: black;font-weight: bold;}
	.join_box .two{width: 8.85rem; font-size: 0.6rem;margin-top:0.6rem;}
	.join_box .three{width: 12.0rem;height: 1.9rem;margin-top:0.6rem;border-radius: 0.15rem;color: white;background-color: #2395ff;}
	.join_box .four{font-size: 0.6rem;margin-top:0.9rem;display: inline-block; color: #2395ff;}
</style>
