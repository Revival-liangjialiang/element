...
<style scoped>
	.special_header{width: 100%;height: 2.5rem;top: 0.0rem;left: 0.0rem;padding-left: 0.75rem;padding-right: 0.75rem;text-align: left;z-index: 10; position: fixed;color: white;}
	.special_header_cover{width: 100%;height: 2.5rem;top: 0.0rem;left: 0.0rem;z-index: 9;opacity: 0; position: fixed;background-color: black;}
	.special_header span{font-size: 0.7rem;line-height: 2.5rem; color: white;}
	.cover_box{width: 16.0rem;height: 2.0rem;overflow: scroll;z-index: 10; background-color: white;}
	...
	.left_move .active{border-color: #56aeff;color: #56aeff;}
</style>
