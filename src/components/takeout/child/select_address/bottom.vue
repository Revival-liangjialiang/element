...
<style scoped>
	.bottom_box p{width: 100%;height: 1.75rem; padding-left: 0.5rem;text-align: left;}
	.bottom_box span{width: 11rem; line-height: 1.75rem;font-size: 0.6rem;}
	.bold{line-height:2.2rem;font-weight: bold; font-size: 0.71rem !important;}
	.nearby_address li{width: 100%;height: 2.15rem;border-bottom: 0.05rem solid #E6E6E6;font-size: 0.6rem;text-align: left;padding-left: 0.5rem;line-height: 2.15rem; background-color: white;}
</style>
