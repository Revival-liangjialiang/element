...
<style scoped>
.header_box{width: 100%;height: 5.0rem;overflow: hidden; background-color: #2395ff;}	
.header_box_child{width: 100%;height: 3.25rem;margin-top: 0.5rem; padding-left: 0.75rem;text-align: left; }
.header_box_child img{width: 3.3rem;height: 3.3rem; border-radius: 50%;display: inline-block;}
.header_box_child p{width: 11rem; height: 1.85rem;top: 0.85rem;left: 0.85rem;vertical-align: top; display: inline-block;}
.header_box_child p span{font-size: 0.75rem;margin-bottom: 0.15rem; display: block;color: white;}
.right_arrow{font-size: 0.7rem; position: absolute;top:0.8rem; right: 0.75rem;color: white;}
.header_box_number,.header_box_number i{font-size: 0.57rem !important;}
</style>
